...
const SettingsTabPanel: FC<SettingsTabPanelProps> = ({ value, index }) => {
  ...
  const [
    ERC1155InsufficientQuantitiesAction,
    setERC1155InsufficientQuantitiesAction,
  ] = useState("SKIP");
              ...
              <AccordionDetails>
                ...
                >
                  <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
                    <Tabs
                      value={inputAssetTabValue}
                      onChange={handleChangeInputAssetTabValue}
              ...
              <AccordionDetails>
                ...
                >
                  <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
                    <Tabs
                      value={modeTabValue}
                      onChange={handleChangeModeTabValue}
                      aria-label="basic tabs example"
                    >
          ...
          >
            ...
            >
              ...
              <AccordionDetails>
                ...
                >
                  <FormControl component="fieldset">
                    <FormLabel component="legend">First Failure:</FormLabel>
                    <RadioGroup
                  ...
                  <FormControl component="fieldset">
                    <FormLabel component="legend">All Failed:</FormLabel>
                    <RadioGroup
                      aria-label="failure-settings"
                      // defaultValue="skip"
                      name="radio-buttons-group"
                  ...
                  <FormControl component="fieldset">
                    ...
                    >
                      ...
                      <FormControlLabel
                        value="buyMax"
                        control={<Radio />}
                        label="Buy The Rest Listed (on the same listing)"
                      />
                    </RadioGroup>
                  </FormControl>
                </Box>
