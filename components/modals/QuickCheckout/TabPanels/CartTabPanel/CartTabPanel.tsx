...
interface CartTabPanelProps {
  ...
  handleDeselectAll: MouseEventHandler<HTMLButtonElement>;
  ...
  openSureModal: (event: React.ChangeEvent<HTMLInputElement>) => void;
  setOpenSureModal: React.Dispatch<React.SetStateAction<boolean>>;
}
const CartTabPanel: FC<CartTabPanelProps> = ({
  value,
  index,
  handleSelectAll,
  handleDeselectAll,
        ...
        >
          ...
          >
            ...
            <Typography variant="body1" color="text.secondary">
              Tap to select and deselect items. Changing your selection will
              update the total price above. The Order is the Order for which the
          ...
          >
            {selectedList.length > 0 && (
              <CartSelectionCardsList
                // listings={cart.cartContextObj.itemList}
                listings={[]}
